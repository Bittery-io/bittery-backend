...
// import { Lnd } from '../model/lnd/external-lnd';
//
// export const insertCustomLnd = async (customLnd: Lnd): Promise<void> => {
//     await dbPool.query(`
...
// };
//
// export const findCustomLnd = async (userEmail: string): Promise<Lnd | undefined> => {
